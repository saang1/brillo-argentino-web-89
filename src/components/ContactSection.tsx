...
Enviado desde la web de Car Detailing.`;
  ...
  return (
    <section id="contacto" className="py-20 bg-neutral-black">
              ...
              <div>
                ...
                >
                  ...
                  {services.map(service => (
                    <option key={service} value={service} className="bg-neutral-black">{service}</option>
                  ))}
                </select>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-support-brown/20 backdrop-blur-sm rounded-2xl p-8 border border-accent-yellow/30">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="text-accent-yellow font-semibold mb-1">🏢 Car Detailing</h4>
                  <p className="text-white">Calle Principal 123</p>
                  <p className="text-support-gray text-sm">Tu Ciudad, Tu Provincia</p>
                </div>
                
                <div>
                  <h4 className="text-accent-yellow font-semibold mb-1">📱 WhatsApp</h4>
                  <a href="https://wa.me/541167336300" className="text-white hover:text-accent-yellow transition-colors">
                    +54 11 6733-6300
                  </a>
                </div>
                
                <div>
                  <h4 className="text-accent-yellow font-semibold mb-1">📧 Email</h4>
                  <a href="mailto:info@cardetailing.com" className="text-white hover:text-accent-yellow transition-colors">
                    info@cardetailing.com
                  </a>
                </div>
                
                <div>
                  <h4 className="text-accent-yellow font-semibold mb-1">🕒 Horarios</h4>
                  <p className="text-white">Lunes a Viernes: 9:00 - 18:00</p>
                  <p className="text-white">Sábados: 10:00 - 15:00</p>
                  <p className="text-support-gray text-sm">Domingos cerrado</p>
                </div>

                <div>
                  <h4 className="text-accent-yellow font-semibold mb-1">📸 Instagram</h4>
                  <a href="https://instagram.com/cardetailing" target="_blank" rel="noopener noreferrer" className="text-white hover:text-accent-yellow transition-colors">
                    @cardetailing
                  </a>
                </div>
              </div>
