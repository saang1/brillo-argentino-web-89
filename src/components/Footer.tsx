...
const Footer = () => {
  ...
  return (
    <footer className="bg-neutral-black text-white py-12 border-t border-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://facebook.com/elitegarajespa"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.tiktok.com/@elitegarajespa"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-300">
                <span className="text-blue-400">📸</span> @elitegarajespa
              </li>
            </ul>
          </div>
        </div>
