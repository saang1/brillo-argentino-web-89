      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className={`font-bold text-lg ${logoTextColor} drop-shadow-md`}>Premium</h1>
              <p className={`text-sm ${logoTextColor} drop-shadow-md opacity-90`}>Car Detailing</p>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <button 
              ...
              className={`font-medium text-lg hover:text-red-500 transition-all duration-200 ${textColorClass} hover:scale-105`}
            >
              Inicio
            </button>
            <button 
            ...
            <button 
              ...
              className="bg-gradient-primary text-white px-6 py-3 rounded-full hover:shadow-xl hover:scale-105 transition-all duration-200 font-semibold border-2 border-white/20"
            >
              Contacto
            </button>
          </nav>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white/98 backdrop-blur-md rounded-lg mt-2 p-4 border border-gray-200 shadow-2xl">
            <nav className="flex flex-col space-y-3">
              <button 
                onClick={() => scrollToSection('inicio')} 
                className="text-gray-700 hover:text-red-600 transition-colors duration-200 text-left py-3 font-medium text-lg hover:bg-gray-50 rounded-lg px-2"
              >
                Inicio
              </button>
              <button 
              ...
              <button 
                onClick={() => scrollToSection('contacto')} 
                className="bg-gradient-primary text-white px-6 py-3 rounded-full hover:shadow-lg transition-all duration-200 text-center mt-2 font-semibold"
              >
                Contacto
              </button>
            </nav>
