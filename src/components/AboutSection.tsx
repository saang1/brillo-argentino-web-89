        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-support-gray mb-6 leading-relaxed">
              Somos especialistas en car detailing con más de 5 años de
              experiencia transformando vehículos en zona oeste. Nuestra pasión
              por la perfección y el detalle nos distingue en el mercado.
            </p>

            <p className="text-lg text-support-gray mb-8 leading-relaxed">
              Utilizamos productos de primera calidad como Sonax certificado y
              técnicas profesionales para devolver a tu auto el brillo y cuidado
              que se merece. Cada trabajo es único y personalizado según las
