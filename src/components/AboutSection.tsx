          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center">
                ...
                <span className="text-gray-300">Productos certificados Sonax</span>
              </div>
              <div className="flex items-center">
                <div className="w-3 h-3 bg-red-500 rounded-full mr-4"></div>
                <span className="text-gray-300">Técnicas profesionales de detailing</span>
              </div>
              <div className="flex items-center">
                <div className="w-3 h-3 bg-red-500 rounded-full mr-4"></div>
              ...
              <div className="flex items-center">
                <div className="w-3 h-3 bg-red-500 rounded-full mr-4"></div>
                <span className="text-gray-300">Garantía en todos nuestros trabajos</span>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-6">
              {stats.map((stat, index) => {
                ...
                return (
                  <div key={index} className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 text-center hover-lift">
